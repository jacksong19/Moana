...
```javascript
// 开发环境
const BASE_URL = 'http://服务器IP:8080/kids/api/v1'

// 生产环境
const BASE_URL = 'https://your-domain.com/kids/api/v1'

// 健康检查端点
const HEALTH_URL = 'http://服务器IP:8080/kids/health'
```

> **注意**: API 使用 `/kids` 前缀，与其他项目区分
